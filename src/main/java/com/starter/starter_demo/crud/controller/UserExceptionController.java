...
public class UserExceptionController {
	...
	public ApiResultError exception(UserAccountDisabledException exception) {
		return ApiResultError.createResponse("User account is disabled.", "CUSTOM_ERROR_STATUS", UUID.randomUUID());
	}
	...
	public ApiResultError exception(UserAccountLockedException exception) {
		return ApiResultError.createResponse("User account is locked.", "CUSTOM_ERROR_STATUS", UUID.randomUUID());
	}
	...
	public ApiResultError exception(UserAccountExpiredException exception) {
		return ApiResultError.createResponse("User account has expired.", "CUSTOM_ERROR_STATUS", UUID.randomUUID());
	}
	...
	public ApiResultError exception(UserPasswordExpiredException exception) {
		return ApiResultError.createResponse("User account's password has expired", "CUSTOM_ERROR_STATUS", UUID.randomUUID());
	}
	...
	public ApiResultError exception(UserInvalidUsernameException exception) {
		return ApiResultError.createResponse("Invalid username", "CUSTOM_ERROR_STATUS", UUID.randomUUID());
	}
	...
	public ApiResultError exception(UserInvalidPasswordException exception) {
		return ApiResultError.createResponse("Invalid password.", "CUSTOM_ERROR_STATUS", UUID.randomUUID());
	}
}
